...
const outcome = inventors.filter((inventor) => {
...
const accendant = inventors.sort((a, b) => a.year - b.year)
console.log(accendant)
...
const livedLongest = inventors.sort((a, b) => {
...
console.log(inventors.find((inventor) => { return inventor.last === "Edison" }))